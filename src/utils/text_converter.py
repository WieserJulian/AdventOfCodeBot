...
def convert_url_to_day_object(base_url, database, year):
...
def getDays(soup: BeautifulSoup, base_url) -> [AdventOfCodeDay]:
    days = []
    main: PageElement = soup.find('main')
    if main:
        ...
        for span in spans:
            ...
            days.append(AdventOfCodeDay(day, href, title, text))
    return days
